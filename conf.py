...
project = 'Tackling the Challenge of Anti-Black Racism'
copyright = '2023, Sarah M Brown, Amelia Moore, Kendall Moore'
...
html_context = {
    ...
    "github_user": "ml4sts",
    "github_repo": "ml4sts.github.io/interdisciplinaryantiracism",
    "github_version": "main",
    "doc_path": ".",
}
